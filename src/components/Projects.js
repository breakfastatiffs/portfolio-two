    ...
    return (
        <main className='proOuter'>
            ...
            <h3>Altergencies</h3>
                ...
                <a href='https://nhresource-client.vercel.app/' className='fa fa-share-alt'>Live App</a>
                <a href='https://github.com/breakfastatiffs/nh-resource-client' className='fa fa-github-alt'>GitHub Client</a>
                <a href='https://github.com/breakfastatiffs/nh-resources-server' className='fa fa-github-alt'>GitHub Server</a>
            </div>
            ...
            <h3>Endless Encounters</h3>
                ...
                <p>FrontEnd: JavaScript, React, CSS 3, HTML 5, and Jest.</p>
                <p>BackEnd: Node.js, Express.js, PostgreSQL, and Mocha & Chai.</p>
                <a href='https://endless-encounters.vercel.app/' className='fa fa-share-alt'>Live App</a>
                <a href='https://github.com/EndlessEncounters/client' className='fa fa-github-alt'>GitHub Client</a>
                <a href='https://github.com/EndlessEncounters/server' className='fa fa-github-alt'>GitHub Server</a>
            </div>
            ...
            <h3>Spanish SRS</h3>
                ...
                <a href='https://language-spaced-repetition.vercel.app/' className='fa fa-share-alt'>Live App</a>
                <a href='https://github.com/thinkful-ei-quail/SR-Client-johnb-tiff' className='fa fa-github-alt'>GitHub Client</a>
                <a href='https://github.com/thinkful-ei-quail/SR-API-johnb-tiff' className='fa fa-github-alt'>GitHub Server</a>
            </div>
